...
.sdmM-ham{
  ...
  box-shadow: inset 0 1px 0 rgba(255,255,255,.6), 0 2px 6px rgba(58,51,45,.08);
  display:inline-flex;
  align-items:center;
...
.sdmM-title{
  ...
  font-weight: 1400;
  -webkit-text-stroke: 0.65px rgba(58,51,45,.65);
}
...
.sdmM-pill{
  ...
  border: 1px solid rgba(58,51,45,.14);
  background: rgba(255,255,255,.55);
...
.sdmMDrawer{
  ...
  box-shadow: 18px 0 40px rgba(58,51,45,.16);
...
.sdmM3Pick a{
  ...
  box-shadow: inset 0 1px 0 rgba(255,255,255,.55), 0 6px 16px rgba(58,51,45,.08);
  text-decoration:none;
...
.sdmMAccBtn span{
  font-size: 15px;
font-weight: 950;
-webkit-text-stroke: 0.55px rgba(58,51,45,.55); /* ✅ 체감 두께 강화 */
  letter-spacing: -.2px;
  color: rgba(58,51,45,.84);
}
.sdmMAccBtn i{
...
.sdmMAllTitle{
  font-size: 14px;
font-weight: 950;
-webkit-text-stroke: 0.55px rgba(58,51,45,.55); /* 체감 두께 업 */
